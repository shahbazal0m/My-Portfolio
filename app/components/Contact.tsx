...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-6 px-6 md:px-24 max-w-[1400px] mx-auto relative z-10">
      <motion.div
      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <div className="glass p-6 md:p-10 rounded-[1rem] border border-white/5 bg-[#0a0a0a]/40 backdrop-blur-xl relative overflow-hidden group order-1 lg:order-2">
            <div className="absolute -top-24 -right-24 w-48 h-48 bg-[#E8A33D]/10 blur-[80px] group-hover:bg-[#E8A33D]/20 transition-all duration-700" />
            ...
            <form ref={formRef} onSubmit={sendEmail} className="space-y-6 relative z-10">
              ...
              <div className="space-y-2">
                ...
                <input 
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-[1rem] px-6 py-2 text-[16px] md:text-base text-white focus:outline-none focus:border-[#E8A33D]/50 transition-all duration-300 placeholder:text-zinc-700"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <textarea 
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-[1rem] px-6 py-2 text-[16px] md:text-base text-white focus:outline-none focus:border-[#E8A33D]/50 transition-all duration-300 placeholder:text-zinc-700 resize-none"
                />
              </div>
              ...
              <button 
                type="submit"
                disabled={loading}
                className="w-full bg-[#E8A33D] hover:bg-amber-400 disabled:bg-zinc-800 text-[#0a0a0a] font-bold py-4 rounded-2xl transition-all duration-300 flex items-center justify-center gap-3 group/btn shadow-lg shadow-[#E8A33D]/20 cursor-pointer text-sm md:text-base"
              >
                {loading ? (
                  <>
                    SENDING...
          ...
          <div className="space-y-10 order-2 lg:order-1">
            <div className="space-y-6">
              ...
              <div className="pl-4 border-l-2 border-[#E8A33D]/40">
                <p className="text-zinc-400 text-sm md:text-[17px] font-sans font-normal tracking-wide leading-relaxed max-w-xl antialiased">
                  I&apos;m always open to discussing <span className="text-zinc-100/85 font-medium">new projects</span>, <span className="text-zinc-100/85 font-medium">creative ideas</span>, or opportunities to be part of <span className="text-[#E8A33D] font-semibold">your vision</span>.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-5 group">
                <div className="w-12 h-12 md:w-14 md:h-14 rounded-2xl bg-[#E8A33D]/10 border border-[#E8A33D]/20 flex items-center justify-center text-[#E8A33D] group-hover:bg-[#E8A33D] group-hover:text-[#0a0a0a] transition-all duration-500 shadow-xl shrink-0">
                  <Phone size={20} />
                </div>
                <div>
              ...
              <div className="p-5 rounded-[1rem] bg-[#E8A33D]/5 border border-[#E8A33D]/10 relative overflow-hidden group/status">
                <div className="flex items-center gap-3 mb-2">
                  <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse "/>
                  <p className="text-[10px] font-bold text-[#E8A33D] uppercase tracking-wider">Current Status</p>
                </div>
