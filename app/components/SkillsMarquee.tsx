      ...
      >
        {duplicatedSkills.map((skill, index) => (
          ...
          >
            ...
            <span className="text-[9px] md:text-[10px] font-bold text-zinc-400/85 group-hover:text-[#E8A33D] transition-all duration-500 uppercase tracking-[0.2em] md:tracking-[0.3em] whitespace-nowrap">
              {skill.name}
            </span>
          </div>
        ))}
